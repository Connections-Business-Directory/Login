...
Includes a `[user_]` shortcode that can be used to display the current logged-in user or specified user profile information include user meta and the user avatar.
