...
Includes a [`[user_]` shortcode](https://connections-pro.com/documentation/login/#user) that can be used to display the current logged-in user or specified user profile information include user meta and the user avatar.
